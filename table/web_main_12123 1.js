...
async function main() {
  ...
  const [scrName, scrUrl] = ['12123.js', 'https://gitcode.net/4qiao/scriptable/raw/master/table/web_12123_0.js'];
  ...
  if (config.runsInWidget) {
    ...
    const cacheFile = getSettingPath()
    await importModule(await webModule(scrName, scrUrl)).main(cacheFile, settings);
    await appleOS();
    return null;
  };
