...
========== Quantumult X ===========
[rewrite_local]
^https:\/\/scgcgwcdn\.sctv-tf\.com\/app\/v1\/mall\/user\/getSignInfo url script-request-header https://gitcode.net/4qiao/scriptable/raw/master/quanX/get_guanCha_token.js
[MITM]
hostname = scgcgwcdn.sctv-tf.com

*/

const $ = new Env('四川观察');
$.token_key = 'guanCha_token';
$.boxjs_token = $.getdata($.token_key);
...
!(async () => {
  ...
  function GetToken() {
    if ($request && $request.url.indexOf("https://scgcgwcdn.sctv-tf.com/app/v1") > -1 && $request.headers) {
